...
class FacialRecognitionApp:
    ...
    def process_current_image(self, action_type):
        ...
        try:
            ...
            if action_type == "detect":
                ...
                # Face analysis with error handling
                try:
                    ...
                    # Handle different formats of results (list or single item)
                    if isinstance(analysis, list):
                        for i, face_data in enumerate(analysis):
                            self.analyze_and_draw_face(result_img, face_data, i, result_text)
                    else:
                        # Single result (not in a list)
                        self.analyze_and_draw_face(result_img, analysis, 0, result_text)
    ...
    def analyze_and_draw_face(self, image, face_data, index, result_text=""):
        ...
        try:
            ...
            print(f"Error in analyze_and_draw_face: {e}")
